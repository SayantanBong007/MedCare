...
const Page = () => {
  ...
  const newdata = data.map((item) => (
    <div className='flex  w-[100%] font-["Nunito Sans"] justify-between border-2 border-[#0360D9] h-[12rem] bg-[#FFFFFF] text-[#000000] p-[2rem] mb-3 mt-3 '>
      <div className="flex">
      <div className="mr-14">
      <Image className="object-cover overflow-hidden  bg-green-400 m-2 rounded-xl"
         src={item.image}
         alt="Doctor Image"
          width={120}
          height={30}/>
