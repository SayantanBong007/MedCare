...
const page = () => {
  ...
  return (
    ...
    <React.Fragment key={index}>
      <img src="/filledstar.png" alt="filled star" />
    </React.Fragment>
     ))}
      {Array.from({ length:5-data.rating }, (_, index) => (
    <React.Fragment key={index}>
      <img src="/unfilledstar.png" alt="filled star" />
    </React.Fragment>
     ))}
    </div>
                      <Link href="/manager/details/id">
                      <button className="bg-blue-700 h-19 text-white rounded-lg p-2 " >Product Analytics</button>
                      </Link>
