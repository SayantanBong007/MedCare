...
const PaymentPage = () => {
  ...
  const [product] = useState({ _id: 1, name: 'Dolo 250', price: 10, quantity: 2 });
            ...
            <div className="flex flex-col gap-4">
              <div style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <div style={{ marginLeft: '20px' }}>
                  ...
                  <p style={{ marginBottom: '40px' }}>Final Price - <b style={{ fontSize: '2.4em' }}>₹{product.price * product.quantity}</b></p>
                </div>
              </div>
            </div>
