...
const page = () => {
  ...
  useEffect(() => {
    const map = new Map({
      ...
      style: 'https://api.maptiler.com/maps/streets-v2/style.json?key=eYEzTHGTC1rxkqJeeNuJ', // Example style
        ...
        <div>
          <div className="flex">
            ...
            <div className='text-black ml-[1rem] font-["Nunito Sans"]'>
              ...
              <p className="text-sm" >Deliver to <span>{loc}</span></p>
            </div>
          </div>
          <div
            id="map"
            ref={mapContainer}
            className="w-[19rem] h-[10rem] mt-[1rem] mr-[1rem]  rounded-md"
          >
            {/* map */}
      ...
      <div className="bottom">
        <div className="flex items-center">
          ...
          <input
            ...
            type="text"
          />
          <button className="h-[4rem] w-[10rem] ml-[4rem] mt-[2.5rem] bg-[#0360D9] p-[1rem] rounded-md text-[1.4rem] flex justify-center items-center ">
            Search
          </button>
        </div>
